        ...
        try {
            ...
            if (($context["items"] ?? null)) {
                ...
                if ((($context["menu_level"] ?? null) == 0)) {
                    // line 30
                    echo "      <ul";
                    echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute(($context["attributes"] ?? null), "addClass", array(0 => "menu", 1 => "nav", 2 => "navbar-nav", 3 => "navbar-right"), "method"), "html", null, true));
                    echo ">
    ";
                } else {
                    // line 32
...
$context["item"], "in_active_trail", array())) ? ("active") : ("")));
  ...
  ";
    ...
    {
        return new Twig_Source("", "themes/bootstrap/templates/menu/menu--account.html.twig", "/Users/adapttech/Sites/devdesktop/lightning-8.x-3.105/themes/bootstrap/templates/menu/menu--account.html.twig");
    }
}
