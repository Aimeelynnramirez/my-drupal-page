...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . ($context["icon_position"] ?? null))) : ("")));
  ...
  ";
    ...
    {
        return new Twig_Source("", "themes/bootstrap/templates/input/input--button--split.html.twig", "/Users/adapttech/Sites/devdesktop/lightning-8.x-3.105/themes/bootstrap/templates/input/input--button--split.html.twig");
    }
}
